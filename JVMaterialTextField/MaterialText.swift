//
//  ASMaterialText.swift
//  AberturaSantander
//
//  Created by José Victor Pereira Costa on 14/04/2018.
 ...
 */
@IBDesignable
open class MaterialText: UITextField { // swiftlint:disable:this type_body_length
    /**
    ...
    fileprivate final func init_ASMaterialText() {
        borderStyle = .none
        createTitleLabel()
        createLineView()
        updateColors()
    ...
    fileprivate func addEditingChangedObserver() {
        self.addTarget(self, action: #selector(MaterialText.editingChanged), for: .editingChanged)
    }
